...
const HomeView = () => {
	...
	return (
		<React.Fragment>
			<Banner className={classes.banner} id="carouselHomeBanner" data={data.banner} />
			<div className="container-fluid bg-light mb-3">
				<div className="row g-3">
					<div className="col-md-9">
						<Carousel id="elect-product-category" className={('mb-3', classes.craouselContent)}>
							{carouselContent}
						</Carousel>
			...
			<div className="container">
				<div className="row">
					<div className="col-md-3 mens-section">
